...
//
//     final movieCreditsResponseModel = movieCreditsResponseModelFromJson(jsonString);

import 'dart:convert';

MovieCreditsResponseModel movieCreditsResponseModelFromJson(String str) =>
    MovieCreditsResponseModel.fromJson(json.decode(str));

String movieCreditsResponseModelToJson(MovieCreditsResponseModel data) =>
