...
TopRatedResponseModel topRatedResponseModelFromJson(String str) =>
    TopRatedResponseModel.fromJson(json.decode(str));

String topRatedResponseModelToJson(TopRatedResponseModel data) =>
